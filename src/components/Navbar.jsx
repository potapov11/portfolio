				...
				<div className="w-full flex justify-between items-center max-w-7xl mx-auto">
					<Link
						...
						<p className="text-white text-[20px] font-bold cursor-pointer flex">
							Потапов&nbsp;
							<span className="sm:block hidden">Сергей</span>
						</p>
					</Link>
					...
					<div className="sm:hidden flex flex-1 justify-end items-center">
						...
						<div className={`p-4 black-gradient absolute top-14 right-0 mx-2 my-2 min-w-[120px] z-10 rounded-xl foggy-glass ${toggle ? 'flex' : 'hidden'}`}>{renderNavLinks(true)}</div>
					</div>
				</div>
			</nav>
		</>
